...
if len(sys.argv)<6:
	print("use : "+sys.argv[0]+" <firmver> <cnver> <extensionless_output_name> <input_file1> <input_file2> ...")
	exit()
...
open(sys.argv[3]+".h","w").write(outputConstantsH(l))
open(sys.argv[3]+".s","w").write(outputConstantsS(l))
open(sys.argv[3]+".py","w").write(outputConstantsPY(l))
